...
```{r}
dataTrAtumor<-subset(dataMurine,dataMurine$Grupo== 'A'); dataTrAtumor<-dataTrAtumor[-c(2)]
dataTrAtumorless<-subset(dataMurine,dataMurine$Grupo== 'B'); dataTrAtumorless<-dataTrAtumorless[-c(2)]
dataTrBtumor<-subset(dataMurine,dataMurine$Grupo== 'C'); dataTrBtumor<-dataTrBtumor[-c(2)]
dataTrBtumorless<-subset(dataMurine,dataMurine$Grupo== 'D'); dataTrBtumorless<-dataTrBtumorless[-c(2)]
dataTrCtumor<-subset(dataMurine,dataMurine$Grupo== 'I'); dataTrCtumor<-dataTrCtumor[-c(2)]
dataTrCtumorless<-subset(dataMurine,dataMurine$Grupo== 'J'); dataTrCtumorless<-dataTrCtumorless[-c(2)]
```
...
plot(dataMurine$Grupo,dataMurine$Reestimulación,col = "green", xlab= "grupo", ylab= "reestimulación") #la reestimulación por cada grupo del estudio
